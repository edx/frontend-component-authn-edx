import POST_AUTH_PARAMS from './constants';

/**
 * Filters context data to include only keys specified in POST_AUTH_PARAMS.
 *
...
const validateContextData = (context) => {
  if (context) {
    return Object.fromEntries(
      Object.entries(context).filter(([key]) => POST_AUTH_PARAMS.includes(key)),
    );
  }
  return context;
};
